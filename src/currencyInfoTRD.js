...
import type { DecredSettings } from './trdTypes.js'

const defaultSettings:DecredSettings = {
  decredServers: [
    'http://decred-az-braz.airbitz.co:8080'
  ]
}
...
const currencyInfo:AbcCurrencyInfo = { // Details of supported currency
  ...
  addressExplorer: 'http://decred-az-braz.airbitz.co:5984/_utils/document.html?db_addresses/%s',
  transactionExplorer: 'http://decred-az-braz.airbitz.co:5984/_utils/document.html?db_transactions/%s',
  defaultSettings,
